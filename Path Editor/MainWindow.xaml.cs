...
partial class MainWindow : Window
{
    ...
    private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            oldViewModel.CompletePaths.Added -= Redraw;
            oldViewModel.CompletePaths.Removed -= Redraw;
            oldViewModel.CompletePaths.Reset -= Redraw;
            oldViewModel.PropertyChanging -= ViewModel_PropertyChanging;
            oldViewModel.PropertyChanged -= ViewModel_PropertyChanged;
        }
        if (e.NewValue is EditorViewModel newViewModel)
        {
            newViewModel.CompletePaths.Added += Redraw;
            newViewModel.CompletePaths.Removed += Redraw;
            newViewModel.CompletePaths.Reset += Redraw;
    ...
    private void Redraw(object sender, DrawablePath path) => Redraw();
