...
public partial class DrawnPaths(DrawnPaths.DrawnPath[] drawnPaths, Size canvasSize)
{
    ...
    /// <summary>
    /// Load a DrawnPaths object from a binary ".paths" file.
    /// </summary>
    /// <param name="stream">The stream to read from.</param>
    /// <returns>The loaded DrawnPaths object.</returns>
    ...
    /// <summary>
    /// Saves the current DrawnPaths object to a binary ".paths" file.
    /// </summary>
    ...
    /// <summary>
    /// Loads a DrawnPaths object from a C# source file.
    /// </summary>
    /// <param name="stream">The stream to read from.</param>
    /// <returns>
    /// A DrawnPaths object if the file is successfully parsed; otherwise, null.
    /// </returns>
    /// <remarks>
    /// The method reads a C# source file containing a representation of a DrawnPaths object.
    ...
    /// <summary>
    /// Saves the current DrawnPaths object as a C# source file.
    /// </summary>
    /// <param name="stream">The stream to which to write.</param>
    /// <param name="name">The name of the file, used as the basis for name of the DrawnPaths object in the generated C# file.</param>
    /// <remarks>
    /// The generated C# file will include a representation of the DrawnPaths object, 
    ...
    /// <summary>
    /// Saves the current DrawnPaths object as a bitmap image.
    /// </summary>
    ...
    /// <summary>
    /// Prints the current DrawnPaths object using a PrintDialog.
    /// </summary>
    ...
    /// <summary>
    /// Creates a Path object from a DrawnPath object.
    /// </summary>
    /// <param name="path">The DrawnPath object to convert.</param>
    /// <returns>A Path object representing the DrawnPath.</returns>
